 ...
 */
	...
	$form->prefixe="rnsup$id";
	
	$form->ajoute_entree('id', 'hidden', $id, '', array(1));
	$form->ajoute_entree('nom', 'texte_court', $s['nom'], 'Nom', array(1));
	$html="";
	$js="";
	$form->ajoute_interrupteur('valider', 'bouton', 'Enregistrer', 'bouton', 1, 'publipostage/ren_support');
	...
	$js.="
$('#rnsup$id .bouton').button();
$('#rnsup$id input').focus();
$('#rnsup$id input').select();
";
